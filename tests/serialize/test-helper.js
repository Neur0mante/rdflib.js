...
var TestHelper = (function () {
  function TestHelper (folder) {
    ...
    this.kb = new lib_1.default.graph()
    this.fetcher = lib_1.default.fetcher(this.kb)
    this.contentType = 'text/turtle'
    this.base = 'file://' + this.reverseSlash(process.cwd()) + '/' + this.testFolder
    this.targetDocument = lib_1.default.sym(this.base + 'stdin') // defaul URI of test data
  }
  TestHelper.prototype.setBase = function (base) {
    this.base = lib_1.default.uri.join(base, this.base)
  }
  ...
  TestHelper.prototype.loadFile = function (file) {
    ...
    var _this = this
    var document = lib_1.default.sym(lib_1.default.uri.join(file, this.base))
  ...
  TestHelper.prototype.outputFile = function (file, format) {
    ...
    var out
    try {
      out = lib_1.default.serialize(this.targetDocument, this.kb, this.targetDocument.uri, this.contentType)
    }    catch (e) {
    ...
    var doc = lib_1.default.sym(lib_1.default.uri.join(file, this.base))
  ...
  TestHelper.prototype.dump = function (file) {
    ...
    var out
    try {
      out = lib_1.default.serialize(null, this.kb, this.targetDocument.uri, 'application/n-quads') // whole store
    }    catch (e) {
      console.log('Error in serializer: ' + e + this.stackString(e))
    }
    console.log(out)
  ...
  TestHelper.prototype.version = function () {
    console.log('rdflib built: ' + lib_1.default.buildTime)
  }
